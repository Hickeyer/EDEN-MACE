...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
        this.createVertexTemplateEntry('startSign;ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, 'start', '开始', null, null, '开始'),
		this.createVertexTemplateEntry('taskSign;rounded=0;whiteSpace=wrap;html=1;', 120, 60, 'task', '任务', null, null, '任务盒子'),
