 ...
 */
Menus.prototype.defaultMenuItems = ['file', 'view'];
...
Menus.prototype.init = function()
{
	...
	{
		/*'outline', 'layers', '-', 'pageView', 'pageScale', '-', 'scrollbars', 'tooltips', '-',
		...
		this.addMenuItems(menu, ((this.editorUi.format != null) ? ['formatPanel'] : []).
			concat(['outline', '-', 'pageView', '-', 'scrollbars',  '-',
			        'grid',  '-',
	...
	{
		//'new', 'open', '-', , 'saveAs', '-', 'import', 'export', '-', 'pageSetup', 'print'
		// this.addMenuItems(menu, ['save'], parent);
        this.addMenuItems(menu, ['save', '-','undo', 'redo', '-', 'cut', 'copy', 'paste', 'delete', '-', 'duplicate', '-',
