...
DisProfiParamInfoDlg.close = function() {
    parent.layer.close(window.parent.DisProfiParamAgent.layerIndex);
}
...
DisProfiParamInfoDlg.addSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/disProfiParamAgent/add", function(data){
        Feng.success("添加成功!");
        window.parent.DisProfiParamAgent.table.refresh();
...
DisProfiParamInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/disProfiParamAgent/update", function(data){
        Feng.success("修改成功!");
        window.parent.DisProfiParamAgent.table.refresh();
        DisProfiParamInfoDlg.close();
    },function(data){
