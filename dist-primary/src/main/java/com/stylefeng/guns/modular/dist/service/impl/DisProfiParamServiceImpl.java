...
public class DisProfiParamServiceImpl implements IDisProfiParamService {
    ...
    public List<Map<String, Object>> selectList(String account,String calModel,String accountType,String disUserType,String disUserRank,String identityType) {
        List<Map<String, Object>> list=disProfitParamDao.selectList(account,calModel, accountType, disUserType, disUserRank,identityType);
        return list;
    }
