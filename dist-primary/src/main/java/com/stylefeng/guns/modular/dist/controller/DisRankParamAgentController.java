 ...
 */
@Controller
@RequestMapping("/DisRankParamAgent")
public class DisRankParamAgentController extends BaseController {

    private String prefix = "/dist/DisRankParamAgent/";
    ...
    public Object list(String calModel,String accountType,String disUserType,String disUserRank) {
        ...
        List<Map<String, Object>> list = disRankParamService.selectList(account,calModel, accountType, disUserType, disUserRank, IdentityStatus.PLAT_STATUS.getStatus());
    ...
    public Object add(DisRankParam param) {
        ...
        param.setIdentityType(IdentityStatus.PLAT_STATUS.getStatus());
        param.setDisUserType(UserTypeStatus.PLAT_STATUS.getStatus());
