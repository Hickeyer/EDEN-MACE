 ...
 */
@Controller
        @RequestMapping("/disProfiParamAgent")
public class DisProfitParamAgentController extends BaseController {
    ...
    public DisProfitParamAgentController() {
        PREFIX = "/dist/disProfiParamAgent/";
    }
    ...
    public Object list(String calModel,String accountType,String disUserType,String disUserRank) {
        ...
        List<Map<String, Object>> list=disProfiParamService.selectList(account,calModel, accountType, disUserType, disUserRank, IdentityStatus.PLAT_STATUS.getStatus());
