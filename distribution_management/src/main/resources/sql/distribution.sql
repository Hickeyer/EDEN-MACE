...
CREATE TABLE `dis_rank_integral_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='系统积分记录表';

/*Data for the table `dis_rank_integral_record` */

insert  into `dis_rank_integral_record`(`id`,`dis_user_id`,`sys_integral`,`is_use`,`is_expire`,`before_integral`,`after_integral`,`expire_time`,`add_time`,`dis_pro_type`,`source_user_id`,`source_remak`,`use_time`,`use_remark`) values (5,'qingchao',10,'N','N',110,120,'2021-04-18 23:31:43','2018-07-23 23:31:43','2','yaoqingjf1','您的邀请下级yaoqingjf1,您获得120积分',NULL,NULL),(6,'qingchao',10,'N','N',120,130,'2021-04-25 12:21:10','2018-07-30 12:21:10','2','shunzhi','您的邀请下级shunzhi,您获得130积分',NULL,NULL),(7,'qingchao',10,'N','N',130,140,'2021-04-25 12:21:28','2018-07-30 12:21:28','0','shunzhi','您的下级shunzhi交易100元,您获得140积分',NULL,NULL),(8,'shunzhi',10,'N','N',0,10,'2021-04-25 12:21:28','2018-07-30 12:21:28','0','shunzhi','您的下级shunzhi交易100元,您获得10积分',NULL,NULL),(9,'mingchao',100,'N','N',290,390,'2021-06-30 00:57:55','2018-10-04 00:57:55','0','qingchao','您的下级qingchao交易1000元,您获得390积分',NULL,NULL);
...
CREATE TABLE `dis_trade_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='交易金额记录表';

/*Data for the table `dis_trade_record` */

insert  into `dis_trade_record`(`id`,`dis_user_id`,`trade_num`,`trade_amount`,`trade_time`) values (1,'shunzhi','1sss','100.00','2018-07-30 12:21:28'),(2,'qingchao','333333','1000.00','2018-10-04 00:57:55');
