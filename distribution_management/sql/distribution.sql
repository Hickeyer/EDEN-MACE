...
CREATE TABLE `dis_amount_situation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=utf8 COMMENT='账户变动表，用于记录账户变动情况';
...
CREATE TABLE `dis_profit_param` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='分润参数设置';

/*Data for the table `dis_profit_param` */

insert  into `dis_profit_param`(`id`,`dis_platform_id`,`dis_pro_mode`,`dis_pro_type`,`dis_pro_value`,`dis_pro_level`,`dis_user_type`,`is_delete`,`update_time`,`add_time`,`dist_trade_mode`) values (2,'dist','0','0','0.1','2','1','N','2018-04-05 16:30:21','2018-04-05 16:30:21','0'),(4,'dist','0','0','0.1','1','1','N',NULL,'2018-05-28 21:04:31','0'),(6,'dist','1','0','1','1','10000','N',NULL,'2018-05-28 21:53:58','0'),(7,'dist','0','0','0.01','1','0','N',NULL,'2018-05-30 15:46:21','0'),(9,'admin','1','0','60','1','10000','N',NULL,'2018-06-10 11:33:01',NULL),(10,'dist','0','0','0.2','1','2','N',NULL,'2018-06-11 22:26:09',NULL),(11,'dist','1','1','1','1','0','N',NULL,'2018-06-11 22:26:57',NULL),(12,'dist','1','0','20','2','10000','N',NULL,'2018-06-26 17:31:30',NULL);
