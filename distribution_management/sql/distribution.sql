...
CREATE TABLE `dis_amount_situation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='账户变动表，用于记录账户变动情况';

/*Data for the table `dis_amount_situation` */

insert  into `dis_amount_situation`(`id`,`dis_user_id`,`type`,`before_change_amount`,`after_change_amount`,`add_time`,`specific_before_change_amount`,`specific_after_change_amount`,`dis_pro_type`,`change_amount`) values (11,'mingchao','0','10100.00','10200.00','2018-05-31 21:43:01','10200.00','10300.00','0','100.00'),(12,'dist','0','1.00','2.00','2018-05-31 21:43:02','1.00','2.00','1','1.00'),(13,'admin','0','5.00','6.00','2018-05-31 21:43:02','5.00','6.00','1','1.00'),(14,'mingchao','0','0.00','100.00','2018-05-31 21:45:19','0.00','100.00','0','100.00'),(15,'dist','0','0.00','1.00','2018-05-31 21:45:20','0.00','1.00','1','1.00'),(16,'admin','0','0.00','1.00','2018-05-31 21:45:20','0.00','1.00','1','1.00');
...
CREATE TABLE `dis_profit_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8 COMMENT='分润记录表';

/*Data for the table `dis_profit_record` */

insert  into `dis_profit_record`(`id`,`profit_num`,`dis_platform_id`,`dis_get_user_id`,`dis_set_user_id`,`dis_amount`,`dis_pro_type`,`dis_note`,`dis_user_type`,`dis_order_id`,`is_delete`,`add_time`,`update_time`,`type`,`before_amount`,`after_amount`,`before_pro_amount`,`after_pro_amount`) values (104,NULL,'dist','mingchao','minguo','100.00','0',NULL,'1','tttt','N','2018-05-31 21:45:19','2018-05-31 21:45:19','0',NULL,NULL,NULL,NULL),(105,NULL,NULL,'dist','minguo','1.00','0',NULL,'10000','tttt','N','2018-05-31 21:45:20','2018-05-31 21:45:20','1',NULL,NULL,NULL,NULL),(106,NULL,NULL,'admin','minguo','1.00','0',NULL,'10000','tttt','N','2018-05-31 21:45:20','2018-05-31 21:45:20','1',NULL,NULL,NULL,NULL);
...
insert  into `dis_withdraw_record`(`id`,`dis_user_id`,`withdraw_num`,`total_amount`,`fee_amount`,`real_amount`,`withdraw_time`,`handle_time`,`withdraw_status`) values (2,'mingchao',NULL,'50.00','0.00','50.00','2018-05-31 21:48:19',NULL,'1'),(3,'mingchao',NULL,'50.00','2.00','48.00','2018-05-31 21:50:34',NULL,'1');
